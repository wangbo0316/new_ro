...
from script.CAPITAL import upload
...
class Job(QThread):
    ...
    def run(self):
        ...
        self.sleep(1)
        upload.UploadCAPITAL(self.filename,self)
...
class CAPITAL(QWidget):
    fileName = ""
    def __init__(self,*args):
        super(CAPITAL, self).__init__(*args)
    ...
    def Excel_Loader(self):
        ...
        self.csv_lable.setText('请点击右侧按钮选择综资清单......')
