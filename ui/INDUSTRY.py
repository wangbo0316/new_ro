...
from script.INDUSTRY import upload
...
class Job(QThread):
    ...
    def run(self):
        ...
        self.sleep(1)
        upload.UploadINDUSTRY(self.filename,self)
...
class INDUSTRY(QWidget):
    fileName = ""
    def __init__(self,*args):
        super(INDUSTRY, self).__init__(*args)
    ...
    def Excel_Loader(self):
        ...
        self.csv_lable.setText('请点击右侧按钮选择行业关键词表......')
